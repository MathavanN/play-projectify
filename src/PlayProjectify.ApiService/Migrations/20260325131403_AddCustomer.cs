        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredCurrency = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false, defaultValue: "CHF"),
                    PreferredLanguage = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false, defaultValue: "en"),
                    MarketingOptIn = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
